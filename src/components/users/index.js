...
app.post('/logup', (req, res) => {
  ...
  connection.query(`insert into users (mail, password, first_name, last_name, birthday, city, id_sex) values ('${mail}', '${password}', '${first_name}', '${last_name}', '${birthday}', ${city}, ${id_sex})`, () => {
    res.json({
